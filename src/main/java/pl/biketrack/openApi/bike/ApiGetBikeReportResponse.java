...
@Operation(
        summary = "Generuj raport roweru",
        description = "Generuje raport PDF dla konkretnego roweru na podstawie jego UUID",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Raport PDF wygenerowany poprawnie",
                        content = @Content(
...
public @interface ApiGetBikeReportResponse {}
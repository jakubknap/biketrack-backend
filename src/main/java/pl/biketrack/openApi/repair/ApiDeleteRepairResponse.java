...
@Operation(
        ...
        description = "Pozwala użytkownikowi usunąć istniejącą naprawę roweru",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Naprawa została pomyślnie usunięta",
                        content = @Content(
...
public @interface ApiDeleteRepairResponse {}